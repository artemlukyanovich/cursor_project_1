    ...
    def post(self):
        ...
        if form.validate_on_submit():
            ...
            product = Products(name=form.name.data, category=form.category.data,
                               definition=form.definition.data, price=form.price.data, img_path=img_path)
...
class ShowProducts(Resource):
    ...
    def post(self):
        ...
        if form.validate_on_submit():
            ...
            products = Products.query.filter(Products.name.like("%{}%".format(name))).\
                filter(Products.category.like(category)).\
